...
function saveChanges() {
	...
	$xml->access_token = $_POST['setting_3'];
	$xml->mercadopago_title = $_POST['setting_4'];
	$xml->mercadopago_description = $_POST['setting_5'];
	$xml->mercadopago_currency = $_POST['setting_6'];
	$xml->mercadopago_return_url = $_POST['setting_7'];
	$xml->mercadopago_api_return_url = $_POST['setting_8'];
